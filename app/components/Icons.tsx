...
export const CloudLightningIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const DropletsIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path d="M12.56 6.6A10.97 10.97 0 0 0 14 3.02c.5 2.5 2.04 4.6 4.14 5.93a.83.83 0 0 1 .42.76c0 .8-.53 1.48-1.25 1.67a4.84 4.84 0 0 0-2.66 1.99c-.12.23-.06.49.14.65.22.17.46.26.72.26 1.1 0 2-.9 2-2 0-.47-.2-.92-.56-1.25C18.56 9.1 20 7.15 20 5c0-1.66-1.34-3-3-3-1.31 0-2.42.83-2.83 2.02" />
  </svg>
);
...
export const HardHatIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  ...
  >
    <path d="M2 18h20" />
    <path d="M12 2v4" />
    <path d="M12 6a6 6 0 0 1 6 6v4H6v-4a6 6 0 0 1 6-6z" />
  </svg>
);

export const ArmchairIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const TreeIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  ...
  >
    ...
    <path d="M7 16v6" />
    <path d="M13 19v3" />
    <path d="M12 19h8.3a1 1 0 0 0 .7-1.7L18 14h.3a1 1 0 0 0 .7-1.7L16 9h.2a1 1 0 0 0 .8-1.7L13 2l-1.4 1.5" />
  </svg>
);
